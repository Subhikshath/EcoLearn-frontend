...
export function SocialLoginButtons({ onGoogleLogin, onFacebookLogin, disabled }: SocialLoginButtonsProps) {
  const { t } = useI18n()
    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button
          ...
          disabled={disabled}
          className="group relative overflow-hidden transition-all duration-300 hover:scale-105 bg-transparent"
        >
